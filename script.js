...
const main = async () => {
  ...
  rStream.push(null)
  await handle.uploadFile({ readStream: rStream, filename: filename }, { dir: DIR })
  ...
  open(`${HBP_COLLAB_HOST}${HBP_COLLAB_PATH}${encodeURIComponent(DIR)}${encodeURIComponent(filename)}`)
}
